...
exports.getShowInfo = function (slug, imdb, cb) {
    var options = {
        headers: {
    ...
    if(typeof imdb !== 'undefined' && imdb != null){
        options["url"] = endpoint + "shows/" + imdb + "?extended=full,images";
    } else {
        options["url"] = endpoint + "shows/" + slug + "?extended=full,images";
    }
