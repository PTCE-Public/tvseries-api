...
var helpers = {
    ...
    extractTrakt: function (show, callback) {
        ...
        var slug = show.slug;
        try {
            eztv.getShowDetails(show, function (err, details) {
                var traktSearch;
                try{
                    traktSearch = details['imdb'];
                } catch (err){
                    traktSearch = slug;
                }
                ...
                Show.findOne({
                    ...
                    if (err || !doc) {
                        ...
                        try {
                            trakt.getShowInfo(traktSearch, function (err, data) {
                        ...
                        if ((now - doc.last_updated) > TTL) {
                            ...
                            try {
                                trakt.getShowInfo(slug, function (err, data) {
                                    if (!err && data) {
