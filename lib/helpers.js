...
var helpers = {
    ...
    refreshDatabase: function () {
        ...
        async.each(providers, function (provider, cb) {
            ...
            // Second argument means 2 proccess
        ...
        try {
            ...
            eztv.getShowDetails(show, function (err, imdb) {
                ...
                Show.findOne({slug: slug}, function (err, doc) {
                    if (err || !doc) {
                        try {
                            console.log("Getting Trakt Info " + show.show + " [" + imdb + "]");
                            trakt.getShowInfo(search, function (err, data) {
                                if (err == null && data) {
                                    ...
                                    var newShow = new Show({
                                        ...
                                        //rating: data.ratings,
                                        genres: data.genres != null ? data.genres : ["Unknown"],
                        ...
                        console.log("Existing Show: " + show.show + " Checking TTL");
